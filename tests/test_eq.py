...
class TestEQ:
    ...
    def test_output_shape(self):
        ...
        out = self.eq(
            signal,
            low_gain=torch.full((4,), 0.5, device=DEVICE),
            mid_gain=torch.full((4,), 0.5, device=DEVICE),
            high_gain=torch.full((4,), 0.5, device=DEVICE),
        )
    ...
    def test_flat_eq_is_passthrough(self):
        ...
        out = self.eq(
            signal,
            low_gain=torch.tensor([0.5], device=DEVICE),
            mid_gain=torch.tensor([0.5], device=DEVICE),
            high_gain=torch.tensor([0.5], device=DEVICE),
        )
    ...
    def test_low_boost_increases_low_energy(self):
        ...
        out = self.eq(
            noise,
            low_gain=torch.tensor([1.0], device=DEVICE),
            mid_gain=torch.tensor([0.5], device=DEVICE),
            high_gain=torch.tensor([0.5], device=DEVICE),
        )
    ...
    def test_no_nan(self):
        ...
        out = self.eq(
            signal,
            low_gain=torch.tensor([0.0], device=DEVICE),
            mid_gain=torch.tensor([1.0], device=DEVICE),
            high_gain=torch.tensor([0.0], device=DEVICE),
        )
